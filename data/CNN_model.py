...
def CNN(X,Y):
    ...
    with tf.name_scope("conv1"):
        conv1 = tf.layers.conv2d(inputs=input_layer, filters=32, kernel_size=[3,3], strides=(1, 1), padding="same",
    ...
    with tf.name_scope("conv2"):
        conv2 = tf.layers.conv2d(inputs=pool1, filters=64, kernel_size=[3,3], strides=(1, 1), padding="same", 
    ...
    with tf.name_scope("conv3"):
        conv3 = tf.layers.conv2d(inputs=pool2, filters=128, kernel_size=[3,3], strides=(1, 1), padding="same", 
                                 activation=tf.nn.leaky_relu)  
    ...
    with tf.name_scope("conv4"):
        conv4 = tf.layers.conv2d(inputs=pool3, filters=256, kernel_size=[3,3], strides=(1, 1), padding="same", 
                                 activation=tf.nn.leaky_relu)  
    ...
    with tf.name_scope("conv5"):
        conv5 = tf.layers.conv2d(inputs=pool4, filters=512, kernel_size=[3,3], strides=(1, 1), padding="same", 
                                 activation=tf.nn.leaky_relu)  
